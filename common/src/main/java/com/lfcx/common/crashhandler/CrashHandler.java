package com.lfcx.common.crashhandler;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    //文件路径
    private static final String PATH = Environment.getExternalStorageDirectory().getPath() +File.separator+ "com.lfcx"+File.separator+"crash";
    private static final String FILE_NAME = "crash";
    private static final String FILE_NAME_SUFEIX = ".crashLog";
