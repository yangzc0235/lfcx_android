...
import com.lfcx.main.fragment.CustomerMainFragment;
import com.lfcx.main.fragment.order.OrderBuildFragment;
import com.lfcx.main.fragment.order.OrderCancelFragment;
import com.lfcx.main.fragment.order.OrderJourneyFragment;
import com.lfcx.main.fragment.order.OrderPayFragment;
import com.lfcx.main.fragment.order.OrderPickFragment;
import com.lfcx.main.fragment.order.OrderSelectFragment;
import com.lfcx.main.fragment.order.OrderWaitFragment;
...
//        }
    ...
    public void onEvent(EventUtil event) {
        if (event.getMsg().equals("wait_receipt")) {
            this.switchFragment(CustomerOrderActivity.PICK);
        }
    }
}
