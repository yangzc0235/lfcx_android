...
public class CustomerRegisterActivity extends CustomerBaseActivity {
     ...
     * @param pwd
     */
    private void goRegist(final String moible, final String pwd){
        showLoading();
        ...
        userAPI.customerLogin(param).enqueue(new Callback<LoginResult>() {
            ...
            public void onResponse(Call<LoginResult> call, Response<LoginResult> response) {
                ...
                try{
                    ...
                    LogUtils.e(CustomerRegisterActivity.this.getClass().getSimpleName(),response.body().toString());
                    if("0".equals(result.getCode())){
                        EventBus.getDefault().post(new EventUtil("reg_success"));
                        showToast("注册成功");
                        SPUtils.setParam(CustomerRegisterActivity.this, SPConstants.KEY_CUSTOMER_PK_USER,result.getPk_user());
                        SPUtils.setParam(CustomerRegisterActivity.this, SPConstants.KEY_CUSTOMER_MOBILE,moible);
                        SPUtils.setParam(CustomerRegisterActivity.this, SPConstants.KEY_CUSTOMER_PWD,pwd);
                        finish();
                    }else {
                    ...
                    hideLoading();
                    LogUtils.e(CustomerRegisterActivity.this.getClass().getSimpleName(),e.getMessage());
                }
            }
            ...
            public void onFailure(Call<LoginResult> call, Throwable t) {
                hideLoading();
                LogUtils.e(CustomerRegisterActivity.this.getClass().getSimpleName(),t.getMessage());
