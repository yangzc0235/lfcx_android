...
import com.lfcx.driver.util.ErrorInfo;
import com.lfcx.driver.util.TTSController;
import com.lfcx.driver.util.TtsSettings;

import java.util.ArrayList;
import java.util.List;

public class DriverBaseActivity extends FragmentActivity implements AMapNaviListener,AMapNaviViewListener {
    ...
    protected NaviLatLng mStartLatlng = new NaviLatLng(39.947219,116.453639);
