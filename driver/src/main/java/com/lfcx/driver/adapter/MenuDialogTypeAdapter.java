 ...
 */
public class MenuDialogTypeAdapter extends BaseAdapter {
    ...
    public MenuDialogTypeAdapter(Context mContext, List<String> menuDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        nameText.setText(menuDatas.get(position));//设置标题
