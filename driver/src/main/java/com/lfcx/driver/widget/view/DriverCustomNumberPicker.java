package com.lfcx.driver.widget.view;
...
public class DriverCustomNumberPicker extends NumberPicker {
    public DriverCustomNumberPicker(Context context, AttributeSet attrs,
                                    int defStyleAttr) {
    ...
    public DriverCustomNumberPicker(Context context) {
        super(context);
    }
